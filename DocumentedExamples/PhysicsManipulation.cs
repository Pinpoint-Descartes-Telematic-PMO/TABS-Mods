...
class PhysicsManipulation
{
    ...
    static void Start()
	{
        ...
        JMTK.instance.guiElements.Add(xElem);
        JMTK.instance.guiElements.Add(yElem);
        JMTK.instance.guiElements.Add(zElem);
        JMTK.instance.guiElements.Add(timeScaleElem);
	}
    ...
    static void Remove()
	{
        ...
        JMTK.instance.guiElements.Remove(xElem);
        JMTK.instance.guiElements.Remove(yElem);
        JMTK.instance.guiElements.Remove(zElem);
        JMTK.instance.guiElements.Remove(timeScaleElem);
	}
}